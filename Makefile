...
help :
	...
	@echo -e "    1. Under the Windows explorer, double-click on the 'subadjust.sln' file, if you have Visual Studio already installed."
	@echo -e "    2. Under MSYS2 bash, by simply running the 'make' command and if Visual Studio is set according to the content of the MSBUILD variable then it will be the default compiler."
	@echo -e "    3. If you have a correctly set Visual Studio configuration but want to force the use of gcc, then run 'make gcc' to build the binaries with gcc."
