...
<sup>*Available to four Linux ![Linux](assets/Tux.svg "Linux") distros (Arch ![Arch](assets/Arch.svg "Arch"), Debian ![Debian](assets/Debian.svg "Fedora"), Fedora ![Fedora](assets/Fedora.svg "Fedora"), Ubuntu ![Ubuntu](assets/Ubuntu.svg "Ubuntu")) and ![Windows](assets/Windows.svg "Windows").*</sup>
