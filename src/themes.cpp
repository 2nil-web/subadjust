...
#define THEME_ENUM PPROC(CLASSIC) PPROC(AERO) PPROC(METRO) PPROC(AQUA) PPROC(GREYBIRD) PPROC(OCEAN) PPROC(BLUE) PPROC(OLIVE) PPROC(ROSE_GOLD) PPROC(DARK) PPROC(BRUSHED_METAL) PPROC(HIGH_CONTRAST)
enum Theme
{
#define PPROC(type) type,
  THEME_ENUM
#undef PPROC
};
...
bool OS::is_classic_windows()
{
  ...
  return VerifyVersionInfo(&osvi, VER_MAJORVERSION | VER_MINORVERSION | VER_SERVICEPACKMAJOR | VER_SERVICEPACKMINOR, cm) != FALSE;
}
...
constexpr bool OS::is_dark_theme(int t)
{
  return t == (int)Theme::DARK || t == (int)Theme::HIGH_CONTRAST;
}
...
{
  Fl::scheme("none");
  Fl::set_boxtype(FL_GTK_UP_BOX, classic_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_DOWN_BOX, classic_check_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_UP_FRAME, classic_button_up_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_DOWN_FRAME, classic_check_down_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_THIN_UP_BOX, classic_panel_thin_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_BOX, classic_spacer_thin_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_UP_FRAME, classic_panel_thin_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_FRAME, classic_spacer_thin_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_ROUND_DOWN_BOX, classic_radio_round_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_UP_BOX, classic_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_DOWN_BOX, classic_check_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_UP_FRAME, classic_button_up_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_DOWN_FRAME, classic_check_down_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_THIN_DOWN_BOX, classic_check_down_box, 2, 3, 4, 6);
  Fl::set_boxtype(FL_PLASTIC_ROUND_DOWN_BOX, classic_check_down_frame, 2, 3, 4, 6);
  Fl::set_boxtype(FL_DIAMOND_UP_BOX, classic_default_button_up_box, 3, 3, 6, 6);
  Fl::set_boxtype(FL_PLASTIC_THIN_UP_BOX, classic_default_button_up_box, 3, 3, 6, 6);
  Fl::set_boxtype(FL_DIAMOND_DOWN_BOX, classic_check_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_ROUND_UP_BOX, FL_FLAT_BOX);
  Fl::set_boxtype(FL_EMBOSSED_BOX, classic_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_ENGRAVED_BOX, classic_check_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_UP_BOX, classic_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_DOWN_BOX, classic_check_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_UP_FRAME, classic_button_up_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_DOWN_FRAME, classic_check_down_frame, 2, 2, 4, 4);
  ...
  Fl::set_boxtype(FL_FREE_BOXTYPE, FL_FLAT_BOX);
  Fl::set_boxtype((Fl_Boxtype)(FL_FREE_BOXTYPE + 1), FL_FREE_BOXTYPE);
  Fl::set_boxtype((Fl_Boxtype)(FL_FREE_BOXTYPE + 2), FL_GTK_THIN_UP_FRAME);
}
...
void OS::use_classic_theme()
{
  ...
  use_classic_colors();
  use_native_settings();
  _current_theme = (int)Theme::CLASSIC;
}
...
static void aero_button_up_box(int x, int y, int w, int h, Fl_Color c)
{
  ...
  {
    // top gradient
    vertical_gradient(x + 2, y + 2, x + w - 3, y + h / 2 - 1, activated_color(fl_rgb_color(0xF1, 0xF1, 0xF1)), activated_color(fl_rgb_color(0xEA, 0xEA, 0xEA)));
    // bottom gradient
    vertical_gradient(x + 2, y + h / 2, x + w - 3, y + h - 3, activated_color(fl_rgb_color(0xDC, 0xDC, 0xDC)), activated_color(fl_rgb_color(0xCE, 0xCE, 0xCE)));
  }
  else
  {
    // left gradient
    horizontal_gradient(x + 2, y + 2, x + w / 2 - 1, y + h - 3, activated_color(fl_rgb_color(0xF1, 0xF1, 0xF1)), activated_color(fl_rgb_color(0xEA, 0xEA, 0xEA)));
    // right gradient
    horizontal_gradient(x + w / 2, y + 2, x + w - 3, y + h - 3, activated_color(fl_rgb_color(0xDC, 0xDC, 0xDC)), activated_color(fl_rgb_color(0xCE, 0xCE, 0xCE)));
  }
...
{
  // top gradient
  vertical_gradient(x + 2, y + 2, x + w - 3, y + h / 2 - 1, activated_color(fl_rgb_color(0xE9, 0xF5, 0xFC)), activated_color(fl_rgb_color(0xD8, 0xEF, 0xFB)));
  // bottom gradient
  vertical_gradient(x + 2, y + h / 2, x + w - 3, y + h - 3, activated_color(fl_rgb_color(0xBD, 0xE5, 0xFC)), activated_color(fl_rgb_color(0xA7, 0xD8, 0xF4)));
...
{
  // top gradient
  vertical_gradient(x + 2, y + 2, x + w - 3, y + h / 2 - 1, activated_color(fl_rgb_color(0xE4, 0xF3, 0xFB)), activated_color(fl_rgb_color(0xC4, 0xE5, 0xF6)));
  // bottom gradient
  vertical_gradient(x + 2, y + h / 2, x + w - 3, y + h - 2, activated_color(fl_rgb_color(0x98, 0xD1, 0xEF)), activated_color(fl_rgb_color(0x68, 0xB3, 0xDB)));
...
{
  // top gradient
  vertical_gradient(x + 3, y + 3, x + w - 4, y + h / 2 - 1, activated_color(fl_rgb_color(0xF0, 0xF3, 0xF5)), activated_color(fl_rgb_color(0xE9, 0xEE, 0xF1)));
  // bottom gradient
  vertical_gradient(x + 3, y + h / 2, x + w - 4, y + h - 4, activated_color(fl_rgb_color(0xD7, 0xE1, 0xE7)), activated_color(fl_rgb_color(0xC8, 0xD5, 0xDD)));
...
{
  Fl::scheme("gtk+");
  Fl::set_boxtype(FL_GTK_UP_BOX, aero_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_DOWN_BOX, aero_check_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_UP_FRAME, aero_button_up_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_DOWN_FRAME, aero_check_down_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_THIN_UP_BOX, aero_panel_thin_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_BOX, aero_spacer_thin_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_UP_FRAME, aero_panel_thin_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_FRAME, aero_spacer_thin_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_ROUND_DOWN_BOX, aero_radio_round_down_box, 3, 3, 6, 6);
  Fl::set_boxtype(FL_PLASTIC_UP_BOX, aero_hovered_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_DOWN_BOX, aero_depressed_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_UP_FRAME, aero_hovered_up_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_DOWN_FRAME, aero_depressed_down_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_THIN_DOWN_BOX, aero_input_thin_down_box, 1, 2, 2, 4);
  Fl::set_boxtype(FL_PLASTIC_ROUND_DOWN_BOX, aero_input_thin_down_frame, 1, 2, 2, 4);
  Fl::set_boxtype(FL_DIAMOND_UP_BOX, aero_default_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_THIN_UP_BOX, aero_default_hovered_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_DIAMOND_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_ROUND_UP_BOX, FL_FLAT_BOX);
  Fl::set_boxtype(FL_EMBOSSED_BOX, aero_tabs_box, 2, 1, 4, 2);
  Fl::set_boxtype(FL_ENGRAVED_BOX, aero_swatch_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_GLEAM_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_UP_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_GLEAM_DOWN_FRAME, FL_PLASTIC_DOWN_FRAME);
  Fl::set_boxtype(FL_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_DOWN_BOX, FL_GTK_DOWN_BOX);
  Fl::set_boxtype(FL_ROUND_DOWN_BOX, FL_GTK_ROUND_DOWN_BOX);
  Fl::set_boxtype(FL_FREE_BOXTYPE, FL_FLAT_BOX);
  Fl::set_boxtype((Fl_Boxtype)(FL_FREE_BOXTYPE + 1), FL_FREE_BOXTYPE);
  Fl::set_boxtype((Fl_Boxtype)(FL_FREE_BOXTYPE + 2), FL_GTK_THIN_UP_FRAME);
}
...
static void metro_button_up_box(int x, int y, int w, int h, Fl_Color c)
{
  if (w >= h)
  {
    vertical_gradient(x + 1, y + 1, x + w - 2, y + h - 2, activated_color(fl_rgb_color(0xF0, 0xF0, 0xF0)), activated_color(fl_rgb_color(0xE5, 0xE5, 0xE5)));
  }
  else
  {
    horizontal_gradient(x + 1, y + 1, x + w - 2, y + h - 2, activated_color(fl_rgb_color(0xF0, 0xF0, 0xF0)), activated_color(fl_rgb_color(0xE5, 0xE5, 0xE5)));
  }
...
{
  vertical_gradient(x + 1, y + 1, x + w - 2, y + h - 2, activated_color(fl_rgb_color(0xEC, 0xF4, 0xFC)), activated_color(fl_rgb_color(0xDC, 0xEC, 0xFC)));
...
{
  vertical_gradient(x + 1, y + 1, x + w - 2, y + h - 2, activated_color(fl_rgb_color(0xDA, 0xEC, 0xFC)), activated_color(fl_rgb_color(0xC4, 0xE0, 0xFC)));
...
{
  Fl::scheme("gtk+");
  Fl::set_boxtype(FL_GTK_UP_BOX, metro_button_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_DOWN_BOX, metro_check_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_UP_FRAME, metro_button_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_DOWN_FRAME, metro_check_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_UP_BOX, aero_panel_thin_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_BOX, aero_spacer_thin_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_UP_FRAME, aero_panel_thin_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_FRAME, aero_spacer_thin_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_ROUND_DOWN_BOX, metro_radio_round_down_box, 3, 3, 6, 6);
  Fl::set_boxtype(FL_PLASTIC_UP_BOX, metro_hovered_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_PLASTIC_DOWN_BOX, metro_depressed_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_PLASTIC_UP_FRAME, metro_hovered_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_PLASTIC_DOWN_FRAME, metro_depressed_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_PLASTIC_THIN_DOWN_BOX, metro_input_thin_down_box, 1, 2, 2, 4);
  Fl::set_boxtype(FL_PLASTIC_ROUND_DOWN_BOX, metro_input_thin_down_frame, 1, 2, 2, 4);
  Fl::set_boxtype(FL_DIAMOND_UP_BOX, metro_default_button_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_PLASTIC_THIN_UP_BOX, metro_default_hovered_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_DIAMOND_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_ROUND_UP_BOX, FL_FLAT_BOX);
  Fl::set_boxtype(FL_EMBOSSED_BOX, aero_tabs_box, 2, 1, 4, 2);
  Fl::set_boxtype(FL_ENGRAVED_BOX, aero_swatch_box, 2, 2, 4, 4);
...
void OS::use_metro_theme()
{
  ...
  use_metro_colors();
  use_native_settings();
  _current_theme = (int)Theme::METRO;
}
...
{
  Fl::scheme("gtk+");
  Fl::set_boxtype(FL_GTK_UP_BOX, aqua_button_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_DOWN_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_GTK_UP_FRAME, aqua_button_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_DOWN_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_GTK_THIN_UP_BOX, aqua_panel_thin_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_BOX, aqua_spacer_thin_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_UP_FRAME, aqua_panel_thin_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_FRAME, aqua_spacer_thin_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_ROUND_DOWN_BOX, aqua_radio_round_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_PLASTIC_DOWN_BOX, aqua_depressed_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_PLASTIC_UP_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_PLASTIC_DOWN_FRAME, aqua_depressed_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_PLASTIC_THIN_DOWN_BOX, aqua_input_thin_down_box, 2, 3, 4, 6);
  Fl::set_boxtype(FL_PLASTIC_ROUND_DOWN_BOX, aqua_input_thin_down_frame, 2, 3, 4, 6);
  Fl::set_boxtype(FL_DIAMOND_UP_BOX, aqua_default_button_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_PLASTIC_THIN_UP_BOX, FL_PLASTIC_UP_BOX);
  Fl::set_boxtype(FL_DIAMOND_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_ROUND_UP_BOX, FL_FLAT_BOX);
  Fl::set_boxtype(FL_EMBOSSED_BOX, aqua_tabs_box, 2, 1, 4, 2);
  Fl::set_boxtype(FL_ENGRAVED_BOX, aqua_swatch_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_GLEAM_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_UP_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_GLEAM_DOWN_FRAME, FL_PLASTIC_DOWN_FRAME);
  Fl::set_boxtype(FL_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_DOWN_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_ROUND_DOWN_BOX, FL_GTK_ROUND_DOWN_BOX);
  Fl::set_boxtype(FL_FREE_BOXTYPE, FL_FLAT_BOX);
  Fl::set_boxtype((Fl_Boxtype)(FL_FREE_BOXTYPE + 1), FL_FREE_BOXTYPE);
  Fl::set_boxtype((Fl_Boxtype)(FL_FREE_BOXTYPE + 2), FL_GTK_THIN_UP_FRAME);
...
static void use_aqua_colors()
{
  ...
  Fl::set_color(FL_FREE_COLOR, 0xFB, 0xFB, 0xFB);
...
{
  Fl::scheme("gtk+");
  Fl::set_boxtype(FL_GTK_UP_BOX, greybird_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_DOWN_BOX, greybird_check_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_UP_FRAME, greybird_button_up_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_DOWN_FRAME, greybird_check_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_UP_BOX, greybird_panel_thin_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_BOX, greybird_spacer_thin_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_UP_FRAME, greybird_panel_thin_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_FRAME, greybird_spacer_thin_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_ROUND_DOWN_BOX, greybird_radio_round_down_box, 3, 3, 6, 6);
  Fl::set_boxtype(FL_PLASTIC_UP_BOX, greybird_hovered_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_DOWN_BOX, greybird_depressed_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_UP_FRAME, greybird_hovered_up_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_DOWN_FRAME, greybird_depressed_down_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_THIN_DOWN_BOX, greybird_input_thin_down_box, 2, 3, 4, 6);
  Fl::set_boxtype(FL_PLASTIC_ROUND_DOWN_BOX, greybird_input_thin_down_frame, 2, 3, 4, 6);
  Fl::set_boxtype(FL_DIAMOND_UP_BOX, greybird_default_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_THIN_UP_BOX, FL_PLASTIC_UP_BOX);
  Fl::set_boxtype(FL_DIAMOND_DOWN_BOX, greybird_default_depressed_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_ROUND_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_EMBOSSED_BOX, greybird_tabs_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_ENGRAVED_BOX, FL_GTK_THIN_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_GLEAM_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_UP_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_GLEAM_DOWN_FRAME, FL_PLASTIC_DOWN_FRAME);
...
static void use_greybird_colors()
{
  ...
  Fl::set_color(FL_FREE_COLOR, 0xD9, 0xD9, 0xD9);
...
void OS::use_greybird_theme()
{
  ...
  use_greybird_colors();
  use_native_settings();
  _current_theme = (int)Theme::GREYBIRD;
}
...
static void ocean_button_up_box(int x, int y, int w, int h, Fl_Color c)
{
  if (w >= h)
  {
    int m = h * 3 / 10;
    // top gradient
    vertical_gradient(x + 1, y + 1, x + w - 2, y + m, activated_color(fl_rgb_color(0xDF, 0xE9, 0xF3)), activated_color(fl_rgb_color(0xFF, 0xFF, 0xFF)));
    // bottom gradient
    vertical_gradient(x + 1, y + m, x + w - 2, y + h - 2, activated_color(fl_rgb_color(0xFF, 0xFF, 0xFF)), activated_color(fl_rgb_color(0xBB, 0xD1, 0xE6)));
  }
  else
  {
    int m = w * 3 / 10;
    // left gradient
    horizontal_gradient(x + 1, y + 1, x + m, y + h - 2, activated_color(fl_rgb_color(0xDF, 0xE9, 0xF3)), activated_color(fl_rgb_color(0xFF, 0xFF, 0xFF)));
    // right gradient
    horizontal_gradient(x + m, y + 1, x + w - 2, y + h - 2, activated_color(fl_rgb_color(0xFF, 0xFF, 0xFF)), activated_color(fl_rgb_color(0xBB, 0xD1, 0xE6)));
  }
...
{
  Fl::scheme("none");
  Fl::set_boxtype(FL_GTK_UP_BOX, ocean_button_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_DOWN_BOX, ocean_depressed_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_UP_FRAME, ocean_button_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_DOWN_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_GTK_THIN_UP_BOX, ocean_panel_thin_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_BOX, ocean_spacer_thin_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_UP_FRAME, ocean_panel_thin_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_FRAME, ocean_spacer_thin_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_ROUND_DOWN_BOX, ocean_radio_round_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_PLASTIC_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_PLASTIC_DOWN_BOX, FL_GTK_DOWN_BOX);
  Fl::set_boxtype(FL_PLASTIC_UP_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_PLASTIC_DOWN_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_PLASTIC_THIN_DOWN_BOX, ocean_input_thin_down_box, 1, 2, 2, 4);
  Fl::set_boxtype(FL_PLASTIC_ROUND_DOWN_BOX, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_DIAMOND_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_PLASTIC_THIN_UP_BOX, FL_PLASTIC_UP_BOX);
  Fl::set_boxtype(FL_DIAMOND_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_ROUND_UP_BOX, FL_FLAT_BOX);
  Fl::set_boxtype(FL_EMBOSSED_BOX, ocean_tabs_box, 2, 1, 4, 2);
  Fl::set_boxtype(FL_ENGRAVED_BOX, FL_PLASTIC_THIN_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_GLEAM_DOWN_BOX, FL_GTK_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_UP_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_GLEAM_DOWN_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_DOWN_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_ROUND_DOWN_BOX, FL_GTK_ROUND_DOWN_BOX);
  Fl::set_boxtype(FL_FREE_BOXTYPE, FL_FLAT_BOX);
...
static void use_ocean_colors()
{
  ...
  Fl::set_color(FL_FREE_COLOR, 0xC8, 0XDD, 0xF2);
...
void OS::use_ocean_theme()
{
  ...
  use_ocean_colors();
  use_native_settings();
  _current_theme = (int)Theme::OCEAN;
}
...
static void blue_button_up_box(int x, int y, int w, int h, Fl_Color c)
{
  ...
  {
    // top gradient
    vertical_gradient(x + 2, y + 2, x + w - 3, y + h / 2 - 1, activated_color(fl_rgb_color(0xF0, 0xF6, 0xFB)), activated_color(fl_rgb_color(0xE2, 0xEA, 0xF3)));
    // bottom gradient
    vertical_gradient(x + 2, y + h / 2, x + w - 3, y + h - 3, activated_color(fl_rgb_color(0xD5, 0xE0, 0xED)), activated_color(fl_rgb_color(0xD7, 0xE2, 0xEF)));
  }
  else
  {
    // left gradient
    horizontal_gradient(x + 2, y + 2, x + w / 2 - 1, y + h - 3, activated_color(fl_rgb_color(0xF0, 0xF6, 0xFB)), activated_color(fl_rgb_color(0xE2, 0xEA, 0xF3)));
    // right gradient
    horizontal_gradient(x + w / 2, y + 2, x + w - 3, y + h - 3, activated_color(fl_rgb_color(0xD5, 0xE0, 0xED)), activated_color(fl_rgb_color(0xD7, 0xE2, 0xEF)));
  }
...
{
  // top gradient
  vertical_gradient(x + 2, y + 2, x + w - 3, y + h / 2 - 1, activated_color(fl_rgb_color(0xFF, 0xF0, 0xDF)), activated_color(fl_rgb_color(0xFF, 0xE2, 0xC2)));
  // bottom gradient
  vertical_gradient(x + 2, y + h / 2, x + w - 3, y + h - 3, activated_color(fl_rgb_color(0xFF, 0xCF, 0x6A)), activated_color(fl_rgb_color(0xFF, 0xE9, 0x83)));
...
{
  // top gradient
  vertical_gradient(x + 1, y + 2, x + w - 2, y + h / 2 - 1, activated_color(fl_rgb_color(0xEE, 0xCB, 0x8E)), activated_color(fl_rgb_color(0xF5, 0xC7, 0x79)));
  // bottom gradient
  vertical_gradient(x + 1, y + h / 2, x + w - 2, y + h - 1, activated_color(fl_rgb_color(0xF5, 0xBB, 0x57)), activated_color(fl_rgb_color(0xF3, 0xE1, 0x77)));
...
{
  // top gradient
  vertical_gradient(x + 2, y + 2, x + w - 3, y + h / 2 - 1, activated_color(fl_rgb_color(0xF7, 0xFB, 0xFF)), activated_color(fl_rgb_color(0xED, 0xF3, 0xF8)));
  // bottom gradient
  vertical_gradient(x + 2, y + h / 2, x + w - 3, y + h - 3, activated_color(fl_rgb_color(0xE7, 0xED, 0xF5)), activated_color(fl_rgb_color(0xEA, 0xF1, 0xF8)));
...
{
  Fl::scheme("gtk+");
  Fl::set_boxtype(FL_GTK_UP_BOX, blue_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_DOWN_BOX, aero_check_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_UP_FRAME, blue_button_up_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_DOWN_FRAME, aero_check_down_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_THIN_UP_BOX, blue_panel_thin_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_BOX, blue_spacer_thin_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_UP_FRAME, blue_panel_thin_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_FRAME, blue_spacer_thin_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_ROUND_DOWN_BOX, aero_radio_round_down_box, 3, 3, 6, 6);
  Fl::set_boxtype(FL_PLASTIC_UP_BOX, blue_hovered_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_DOWN_BOX, blue_depressed_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_UP_FRAME, blue_hovered_up_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_DOWN_FRAME, blue_depressed_down_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_THIN_DOWN_BOX, aero_input_thin_down_box, 1, 2, 2, 4);
  Fl::set_boxtype(FL_PLASTIC_ROUND_DOWN_BOX, aero_input_thin_down_frame, 1, 2, 2, 4);
  Fl::set_boxtype(FL_DIAMOND_UP_BOX, blue_default_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_THIN_UP_BOX, FL_PLASTIC_UP_BOX);
  Fl::set_boxtype(FL_DIAMOND_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_ROUND_UP_BOX, FL_FLAT_BOX);
  Fl::set_boxtype(FL_EMBOSSED_BOX, blue_tabs_box, 2, 1, 4, 2);
  Fl::set_boxtype(FL_ENGRAVED_BOX, aero_swatch_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_GLEAM_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_UP_FRAME, FL_GTK_UP_FRAME);
...
static void use_blue_colors()
{
  ...
  Fl::set_color(FL_FREE_COLOR, 0xEA, 0xF1, 0xFA);
  Fl_Tooltip::color(fl_rgb_color(0xFF, 0xFF, 0xFF));
  Fl_Tooltip::textcolor(FL_FOREGROUND_COLOR);
}
...
static void olive_button_up_box(int x, int y, int w, int h, Fl_Color c)
{
  ...
  {
    // top gradient
    vertical_gradient(x + 1, y + 3, x + w - 2, y + h / 3, activated_color(fl_rgb_color(0xFE, 0xFF, 0xF2)), activated_color(fl_rgb_color(0xFA, 0xF9, 0xE9)));
    // bottom gradient
    vertical_gradient(x + 1, y + h / 3, x + w - 2, y + h - 4, activated_color(fl_rgb_color(0xFB, 0xFA, 0xE8)), activated_color(fl_rgb_color(0xF3, 0xEE, 0xDB)));
  }
  else
  {
    // left gradient
    horizontal_gradient(x + 3, y + 1, x + w / 3, y + h - 2, activated_color(fl_rgb_color(0xFE, 0xFF, 0xF2)), activated_color(fl_rgb_color(0xFA, 0xF9, 0xE9)));
    // right gradient
    horizontal_gradient(x + w / 3, y + 1, x + w - 4, y + h - 2, activated_color(fl_rgb_color(0xFB, 0xFA, 0xE8)), activated_color(fl_rgb_color(0xF3, 0xEE, 0xDB)));
  }
...
{
  // top gradient
  vertical_gradient(x + 1, y + 3, x + w - 2, y + h / 3, activated_color(fl_rgb_color(0xDC, 0xE1, 0xD0)), activated_color(fl_rgb_color(0xDF, 0xE1, 0xC8)));
  // bottom gradient
  vertical_gradient(x + 1, y + h / 3, x + w - 2, y + h - 4, activated_color(fl_rgb_color(0xDF, 0xE1, 0xC8)), activated_color(fl_rgb_color(0xD8, 0xDF, 0xC8)));
...
{
  // edges' top gradient
  vertical_gradient(x + 1, y + 3, x + w - 2, y + h / 2 - 1, activated_color(fl_rgb_color(0xF7, 0xC7, 0x61)), activated_color(fl_rgb_color(0xF7, 0xC3, 0x59)));
  // edges' bottom gradient
  vertical_gradient(x + 1, y + h / 2, x + w - 2, y + h - 4, activated_color(fl_rgb_color(0xF7, 0xBF, 0x52)), activated_color(fl_rgb_color(0xF2, 0xA8, 0x13)));
...
{
  // edges' top gradient
  vertical_gradient(x + 1, y + 3, x + w - 2, y + h / 2 - 1, activated_color(fl_rgb_color(0xB0, 0xCC, 0x7D)), activated_color(fl_rgb_color(0xA0, 0xC7, 0x67)));
  // edges' bottom gradient
  vertical_gradient(x + 1, y + h / 2, x + w - 2, y + h - 4, activated_color(fl_rgb_color(0xA0, 0xC7, 0x67)), activated_color(fl_rgb_color(0x90, 0xC1, 0x54)));
  fl_push_clip(x + 3, y + 3, w - 6, h - 6);
  // top gradient
  vertical_gradient(x + 1, y + 3, x + w - 2, y + h / 3, activated_color(fl_rgb_color(0xFE, 0xFF, 0xF2)), activated_color(fl_rgb_color(0xFA, 0xF9, 0xE9)));
  // bottom gradient
...
static void olive_mini_button_up_box(int x, int y, int w, int h, Fl_Color c)
{
  ...
  {
    // left gradient
    horizontal_gradient(x + 1, y + 3, x + w / 2 - 1, y + h - 2, activated_color(fl_rgb_color(0xB0, 0xCC, 0x7D)), activated_color(fl_rgb_color(0xA0, 0xC7, 0x67)));
    // right gradient
    horizontal_gradient(x + w / 2, y + 3, x + w - 2, y + h - 4, activated_color(fl_rgb_color(0xA0, 0xC7, 0x67)), activated_color(fl_rgb_color(0x90, 0xC1, 0x54)));
  }
...
{
  Fl::scheme("none");
  Fl::set_boxtype(FL_GTK_UP_BOX, olive_button_up_box, 1, 3, 2, 6);
  Fl::set_boxtype(FL_GTK_DOWN_BOX, olive_button_down_box, 1, 3, 2, 6);
  Fl::set_boxtype(FL_GTK_UP_FRAME, olive_button_up_frame, 1, 3, 2, 6);
  Fl::set_boxtype(FL_GTK_DOWN_FRAME, olive_button_down_frame, 1, 3, 2, 6);
  Fl::set_boxtype(FL_GTK_THIN_UP_BOX, classic_panel_thin_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_BOX, classic_spacer_thin_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_UP_FRAME, classic_panel_thin_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_FRAME, classic_spacer_thin_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_ROUND_DOWN_BOX, olive_radio_round_down_box, 3, 3, 6, 6);
  Fl::set_boxtype(FL_PLASTIC_UP_BOX, olive_hovered_up_box, 1, 3, 2, 6);
  Fl::set_boxtype(FL_PLASTIC_DOWN_BOX, FL_GTK_DOWN_BOX);
  Fl::set_boxtype(FL_PLASTIC_UP_FRAME, olive_hovered_up_frame, 1, 3, 2, 6);
  Fl::set_boxtype(FL_PLASTIC_DOWN_FRAME, FL_GTK_DOWN_FRAME);
  Fl::set_boxtype(FL_PLASTIC_THIN_DOWN_BOX, olive_input_thin_down_box, 1, 2, 2, 4);
  Fl::set_boxtype(FL_PLASTIC_ROUND_DOWN_BOX, olive_input_thin_down_frame, 1, 2, 2, 4);
  Fl::set_boxtype(FL_DIAMOND_UP_BOX, olive_default_button_up_box, 1, 3, 2, 6);
  Fl::set_boxtype(FL_PLASTIC_THIN_UP_BOX, FL_PLASTIC_UP_BOX);
  Fl::set_boxtype(FL_DIAMOND_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_ROUND_UP_BOX, olive_toolbar_button_hover_box, 1, 2, 2, 4);
  Fl::set_boxtype(FL_EMBOSSED_BOX, olive_tabs_box, 2, 1, 4, 2);
  Fl::set_boxtype(FL_ENGRAVED_BOX, olive_swatch_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_UP_BOX, olive_mini_button_up_box, 1, 3, 2, 6);
  Fl::set_boxtype(FL_GLEAM_DOWN_BOX, FL_GLEAM_UP_BOX);
  Fl::set_boxtype(FL_GLEAM_UP_FRAME, olive_mini_button_up_frame, 1, 3, 2, 6);
  Fl::set_boxtype(FL_GLEAM_DOWN_FRAME, FL_GLEAM_UP_FRAME);
  Fl::set_boxtype(FL_UP_BOX, FL_GTK_UP_BOX);
...
static void use_olive_colors()
{
  ...
  Fl::set_color(FL_FREE_COLOR, 0xFC, 0xFC, 0xFE);
  Fl_Tooltip::color(fl_rgb_color(0xFF, 0xFF, 0xE1));
  Fl_Tooltip::textcolor(FL_FOREGROUND_COLOR);
}
...
void OS::use_olive_theme()
{
  ...
  use_olive_colors();
  use_native_settings();
  _current_theme = (int)Theme::OLIVE;
}
...
static void rose_gold_button_up_box(int x, int y, int w, int h, Fl_Color c)
{
  ...
  {
    // top gradient
    vertical_gradient(x + 2, y + 2, x + w - 3, y + h / 2 - 1, activated_color(fl_rgb_color(0xFD, 0xF0, 0xEF)), activated_color(fl_rgb_color(0xF6, 0xE4, 0xE0)));
    // bottom gradient
    vertical_gradient(x + 2, y + h / 2, x + w - 3, y + h - 3, activated_color(fl_rgb_color(0xF1, 0xD9, 0xD2)), activated_color(fl_rgb_color(0xF3, 0xDB, 0xD4)));
  }
  else
  {
    // left gradient
    horizontal_gradient(x + 2, y + 2, x + w / 2 - 1, y + h - 3, activated_color(fl_rgb_color(0xFD, 0xF0, 0xEF)), activated_color(fl_rgb_color(0xF6, 0xE4, 0xE0)));
    // right gradient
    horizontal_gradient(x + w / 2, y + 2, x + w - 3, y + h - 3, activated_color(fl_rgb_color(0xF1, 0xD9, 0xD2)), activated_color(fl_rgb_color(0xF3, 0xDB, 0xD4)));
  }
...
{
  // top gradient
  vertical_gradient(x + 2, y + 2, x + w - 3, y + h / 2 - 1, activated_color(fl_rgb_color(0xF0, 0xF4, 0xF5)), activated_color(fl_rgb_color(0xE1, 0xE9, 0xEB)));
  // bottom gradient
  vertical_gradient(x + 2, y + h / 2, x + w - 3, y + h - 3, activated_color(fl_rgb_color(0xC0, 0xD0, 0xD8)), activated_color(fl_rgb_color(0xBA, 0xC4, 0xCE)));
...
{
  // top gradient
  vertical_gradient(x + 1, y + 2, x + w - 2, y + h / 2 - 1, activated_color(fl_rgb_color(0xCA, 0xD8, 0xDF)), activated_color(fl_rgb_color(0xD1, 0xDC, 0xE1)));
  // bottom gradient
  vertical_gradient(x + 1, y + h / 2, x + w - 2, y + h - 1, activated_color(fl_rgb_color(0xB7, 0xC9, 0xD0)), activated_color(fl_rgb_color(0xAF, 0xBA, 0xC3)));
...
{
  // top gradient
  vertical_gradient(x + 2, y + 2, x + w - 3, y + h / 2 - 1, activated_color(fl_rgb_color(0xFF, 0xF7, 0xF6)), activated_color(fl_rgb_color(0xFA, 0xED, 0xEC)));
  // bottom gradient
  vertical_gradient(x + 2, y + h / 2, x + w - 3, y + h - 3, activated_color(fl_rgb_color(0xF7, 0xE9, 0xE5)), activated_color(fl_rgb_color(0xFB, 0xEC, 0xE9)));
...
{
  Fl::scheme("gtk+");
  Fl::set_boxtype(FL_GTK_UP_BOX, rose_gold_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_DOWN_BOX, aero_check_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_UP_FRAME, rose_gold_button_up_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_DOWN_FRAME, aero_check_down_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_THIN_UP_BOX, rose_gold_panel_thin_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_BOX, rose_gold_spacer_thin_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_UP_FRAME, rose_gold_panel_thin_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_FRAME, rose_gold_spacer_thin_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_ROUND_DOWN_BOX, aero_radio_round_down_box, 3, 3, 6, 6);
  Fl::set_boxtype(FL_PLASTIC_UP_BOX, rose_gold_hovered_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_DOWN_BOX, rose_gold_depressed_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_UP_FRAME, rose_gold_hovered_up_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_DOWN_FRAME, rose_gold_depressed_down_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_THIN_DOWN_BOX, aero_input_thin_down_box, 1, 2, 2, 4);
  Fl::set_boxtype(FL_PLASTIC_ROUND_DOWN_BOX, aero_input_thin_down_frame, 1, 2, 2, 4);
  Fl::set_boxtype(FL_DIAMOND_UP_BOX, rose_gold_default_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_THIN_UP_BOX, FL_PLASTIC_UP_BOX);
  Fl::set_boxtype(FL_DIAMOND_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_ROUND_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_EMBOSSED_BOX, rose_gold_tabs_box, 2, 1, 4, 2);
  Fl::set_boxtype(FL_ENGRAVED_BOX, aero_swatch_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_GLEAM_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_UP_FRAME, FL_GTK_UP_FRAME);
...
static void use_rose_gold_colors()
{
  ...
  Fl::set_color(FL_FREE_COLOR, 0xFA, 0xEA, 0xF7);
  Fl_Tooltip::color(fl_rgb_color(0xFF, 0xFF, 0xFF));
  Fl_Tooltip::textcolor(FL_FOREGROUND_COLOR);
}
...
void OS::use_rose_gold_theme()
{
  ...
  use_native_settings();
  _current_theme = (int)Theme::ROSE_GOLD;
}
...
static void dark_button_up_box(int x, int y, int w, int h, Fl_Color c)
{
  if (w >= h)
  {
    vertical_gradient(x + 1, y + 2, x + w - 2, y + h - 1, activated_color(fl_rgb_color(0x75, 0x75, 0x75)), activated_color(fl_rgb_color(0x62, 0x62, 0x62)));
  }
  else
  {
    horizontal_gradient(x + 1, y + 2, x + w - 2, y + h - 1, activated_color(fl_rgb_color(0x75, 0x75, 0x75)), activated_color(fl_rgb_color(0x62, 0x62, 0x62)));
  }
...
{
  vertical_gradient(x + 1, y + 2, x + w - 2, y + h - 1, activated_color(fl_rgb_color(0x3F, 0x3F, 0x3F)), activated_color(fl_rgb_color(0x37, 0x37, 0x37)));
...
{
  Fl::scheme("gtk+");
  Fl::set_boxtype(FL_GTK_UP_BOX, dark_button_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_DOWN_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_GTK_UP_FRAME, dark_button_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_DOWN_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_GTK_THIN_UP_BOX, dark_panel_thin_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_BOX, dark_spacer_thin_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_UP_FRAME, dark_panel_thin_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_FRAME, dark_spacer_thin_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_ROUND_DOWN_BOX, dark_radio_round_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_PLASTIC_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_PLASTIC_DOWN_BOX, dark_depressed_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_PLASTIC_UP_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_PLASTIC_DOWN_FRAME, dark_depressed_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_PLASTIC_THIN_DOWN_BOX, dark_input_thin_down_box, 1, 2, 2, 4);
  Fl::set_boxtype(FL_PLASTIC_ROUND_DOWN_BOX, dark_input_thin_down_frame, 1, 2, 2, 4);
  Fl::set_boxtype(FL_DIAMOND_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_PLASTIC_THIN_UP_BOX, FL_PLASTIC_UP_BOX);
  Fl::set_boxtype(FL_DIAMOND_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_ROUND_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_EMBOSSED_BOX, dark_tabs_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_ENGRAVED_BOX, dark_swatch_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_GLEAM_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_UP_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_GLEAM_DOWN_FRAME, FL_PLASTIC_DOWN_FRAME);
...
static void use_dark_colors()
{
  ...
  Fl::set_color(FL_FREE_COLOR, 0x53, 0x53, 0x53);
...
{
  vertical_gradient(x + 1, y + 3, x + w - 2, y + h - 4, activated_color(fl_rgb_color(0xCE, 0xCE, 0xCE)), activated_color(fl_rgb_color(0xFE, 0xFE, 0xFE)));
...
{
  vertical_gradient(x + 1, y + 3, x + w - 2, y + h - 4, activated_color(fl_rgb_color(0xDD, 0xDD, 0xDD)), activated_color(fl_rgb_color(0xAD, 0xAD, 0xAD)));
...
{
  vertical_gradient(x + 1, y + 3, x + w - 2, y + h - 4, activated_color(fl_rgb_color(0xCE, 0xBE, 0x67)), activated_color(fl_rgb_color(0xFE, 0xFC, 0x7F)));
...
{
  vertical_gradient(x + 1, y + 3, x + w - 2, y + h - 4, activated_color(fl_rgb_color(0xDD, 0xD0, 0x6E)), activated_color(fl_rgb_color(0xAD, 0x98, 0x56)));
...
static void brushed_metal_radio_round_down_frame(int x, int y, int w, int h, Fl_Color)
{
  ...
  fl_point(x + w - 5, y);
  fl_point(x + 4, y + h - 1);
  fl_point(x + w - 5, y + h - 1);
  fl_point(x, y + 4);
  fl_point(x, y + h - 5);
  fl_point(x + w - 1, y + 4);
  fl_point(x + w - 1, y + h - 5);
  fl_point(x + 2, y + 1);
  fl_point(x + 1, y + 2);
  fl_point(x + w - 3, y + 1);
  fl_point(x + w - 2, y + 2);
  ...
  fl_point(x + 3, y + h - 2);
  fl_point(x + 1, y + h - 4);
  fl_point(x + w - 4, y + h - 2);
  fl_point(x + w - 2, y + h - 4);
  // medium antialiasing
  ...
  fl_point(x + 3, y + h - 1);
  fl_point(x, y + h - 4);
  fl_point(x + w - 4, y + h - 1);
  fl_point(x + w - 1, y + h - 4);
  ...
  fl_point(x + 4, y + h - 2);
  fl_point(x + 1, y + h - 5);
  fl_point(x + w - 5, y + h - 2);
  fl_point(x + w - 2, y + h - 5);
  // top inner highlight
  fl_color(activated_color(fl_rgb_color(0xFF, 0xFF, 0xFF)));
...
{
  Fl::scheme("gtk+");
  Fl::set_boxtype(FL_GTK_UP_BOX, brushed_metal_button_up_box, 1, 2, 2, 4);
  Fl::set_boxtype(FL_GTK_DOWN_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_GTK_UP_FRAME, brushed_metal_button_up_frame, 1, 2, 2, 4);
  Fl::set_boxtype(FL_GTK_DOWN_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_GTK_THIN_UP_BOX, brushed_metal_panel_thin_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_BOX, brushed_metal_spacer_thin_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_UP_FRAME, brushed_metal_panel_thin_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_FRAME, brushed_metal_spacer_thin_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_ROUND_DOWN_BOX, brushed_metal_radio_round_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_PLASTIC_DOWN_BOX, brushed_metal_depressed_down_box, 1, 2, 2, 4);
  Fl::set_boxtype(FL_PLASTIC_UP_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_PLASTIC_DOWN_FRAME, brushed_metal_depressed_down_frame, 1, 2, 2, 4);
  Fl::set_boxtype(FL_PLASTIC_THIN_DOWN_BOX, brushed_metal_input_thin_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_ROUND_DOWN_BOX, brushed_metal_input_thin_down_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_DIAMOND_UP_BOX, brushed_metal_default_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_THIN_UP_BOX, FL_DIAMOND_UP_BOX);
  Fl::set_boxtype(FL_DIAMOND_DOWN_BOX, brushed_metal_default_depressed_down_box, 1, 2, 2, 4);
  Fl::set_boxtype(FL_GLEAM_ROUND_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_EMBOSSED_BOX, brushed_metal_button_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_ENGRAVED_BOX, brushed_metal_swatch_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_UP_BOX, FL_GTK_UP_BOX);
  Fl::set_boxtype(FL_GLEAM_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_UP_FRAME, FL_GTK_UP_FRAME);
  Fl::set_boxtype(FL_GLEAM_DOWN_FRAME, FL_PLASTIC_DOWN_FRAME);
  ...
  Fl::set_boxtype(FL_DOWN_BOX, FL_GTK_DOWN_BOX);
  Fl::set_boxtype(FL_ROUND_DOWN_BOX, FL_GTK_ROUND_DOWN_BOX);
  Fl::set_boxtype(FL_FREE_BOXTYPE, brushed_metal_bg_box, 0, 0, 0, 0);
  Fl::set_boxtype((Fl_Boxtype)(FL_FREE_BOXTYPE + 1), FL_FREE_BOXTYPE);
  Fl::set_boxtype((Fl_Boxtype)(FL_FREE_BOXTYPE + 2), dummy_box_frame, 1, 1, 2, 2);
}
...
static void use_brushed_metal_colors()
{
  ...
  Fl::set_color(FL_FREE_COLOR, 0xCB, 0xCB, 0xCB);
...
void OS::use_brushed_metal_theme()
{
  ...
  use_native_settings();
  _current_theme = (int)Theme::BRUSHED_METAL;
}
...
{
  Fl::scheme("none");
  Fl::set_boxtype(FL_GTK_UP_BOX, high_contrast_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_DOWN_BOX, high_contrast_check_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_UP_FRAME, high_contrast_button_up_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_DOWN_FRAME, high_contrast_check_down_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GTK_THIN_UP_BOX, high_contrast_panel_thin_up_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_BOX, high_contrast_spacer_thin_down_box, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_UP_FRAME, high_contrast_panel_thin_up_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_THIN_DOWN_FRAME, high_contrast_spacer_thin_down_frame, 1, 1, 2, 2);
  Fl::set_boxtype(FL_GTK_ROUND_DOWN_BOX, high_contrast_radio_round_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_UP_BOX, high_contrast_hovered_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_DOWN_BOX, high_contrast_check_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_UP_FRAME, high_contrast_hovered_up_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_DOWN_FRAME, high_contrast_check_down_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_THIN_DOWN_BOX, high_contrast_check_down_box, 2, 3, 4, 6);
  Fl::set_boxtype(FL_PLASTIC_ROUND_DOWN_BOX, high_contrast_check_down_frame, 2, 3, 4, 6);
  Fl::set_boxtype(FL_DIAMOND_UP_BOX, high_contrast_default_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_PLASTIC_THIN_UP_BOX, FL_PLASTIC_UP_BOX);
  Fl::set_boxtype(FL_DIAMOND_DOWN_BOX, FL_PLASTIC_DOWN_BOX);
  Fl::set_boxtype(FL_GLEAM_ROUND_UP_BOX, FL_PLASTIC_UP_BOX);
  Fl::set_boxtype(FL_EMBOSSED_BOX, high_contrast_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_ENGRAVED_BOX, high_contrast_check_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_UP_BOX, high_contrast_button_up_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_DOWN_BOX, high_contrast_check_down_box, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_UP_FRAME, high_contrast_button_up_frame, 2, 2, 4, 4);
  Fl::set_boxtype(FL_GLEAM_DOWN_FRAME, high_contrast_check_down_frame, 2, 2, 4, 4);
...
static void use_high_contrast_colors()
{
  ...
  Fl::set_color(FL_FREE_COLOR, 0x20, 0x20, 0x20);
...
void OS::use_high_contrast_theme()
{
  ...
  use_native_settings();
  _current_theme = (int)Theme::HIGH_CONTRAST;
}

/********************************** OS Native *********************************/

#ifdef _WIN32
int OS::_current_theme = is_classic_windows() ? (int)Theme::CLASSIC : is_modern_windows() ? (int)Theme::METRO : (int)Theme::AERO;
#else
int OS::_current_theme = (int)Theme::GREYBIRD;
#endif
...
void OS::use_native_fonts()
{
  ...
  size_t n = my_wcstombs(system_font, metrics.lfMessageFont.lfFaceName, sizeof(system_font));
  ...
  const char *italic_monospace_fonts[] = {"Consolas italic", "Lucida Console italic", "Courier New italic"};
  ...
  const char *bold_italic_monospace_fonts[] = {"Consolas bold italic", "Lucida Console bold italic", "Courier New bold italic"};
  ...
  const char *system_fonts[] = {"Ubuntu", "Noto Sans", "Droid Sans", "DejaVu Sans"};
  use_any_font(OS_FONT, system_fonts, _countof(system_fonts));
  // Use common monospace font
  const char *monospace_fonts[] = {"Ubuntu Mono", "Noto Sans Mono", "Droid Sans Mono", "DejaVu Sans Mono"};
  use_any_font(FL_COURIER, monospace_fonts, _countof(monospace_fonts));
  // Use common bold monospace font
  const char *bold_monospace_fonts[] = {"Ubuntu Mono Bold", "Noto Sans Mono Bold", "Droid Sans Mono Bold", "DejaVu Sans Mono Bold"};
  use_any_font(FL_COURIER_BOLD, bold_monospace_fonts, _countof(bold_monospace_fonts));
  // Use common italic monospace font
  const char *italic_monospace_fonts[] = {"Ubuntu Mono italic", "Noto Sans Mono italic", "Droid Sans Mono italic", "DejaVu Sans Mono italic"};
  use_any_font(FL_COURIER_ITALIC, italic_monospace_fonts, _countof(italic_monospace_fonts));
  // Use common bold italic monospace font
  const char *bold_italic_monospace_fonts[] = {"Ubuntu Mono bold italic", "Noto Sans Mono bold italic", "Droid Sans Mono bold italic", "DejaVu Sans Mono bold italic"};
  use_any_font(FL_COURIER_BOLD_ITALIC, bold_italic_monospace_fonts, _countof(bold_italic_monospace_fonts));
#endif
...
std::vector<std::string> OS::themeStrVec = {
#define PPROC(type) #type,
    THEME_ENUM
#undef PPROC
};

std::string OS::themes_string()
{
  int n = (int)Theme::CLASSIC;

  std::string ret = "";
  for (auto s : themeStrVec)
  {
    ret += "  ";
    if (n == (int)_current_theme)
      ret += "[";
    ret += s + " ==> " + std::to_string(n);
    if (n == (int)_current_theme)
      ret += ']';
    n++;
  }
...
std::string OS::current_theme_string()
{
  return themeStrVec[_current_theme];
}

int OS::default_theme()
{
#ifdef _WIN32
  DWORD reg_value = 1, reg_size = sizeof(reg_value);
  if (!RegGetValueA(HKEY_CURRENT_USER, "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Themes\\Personalize", "AppsUseLightTheme", RRF_RT_REG_DWORD, NULL, &reg_value, &reg_size) && reg_value == 0)
  {
    return (int)Theme::DARK;
  }
  else
  {
    return (int)Theme::METRO;
  }
#else
  return (int)Theme::GREYBIRD;
#endif
}

int OS::theme_from_string(std::string str)
{
...
std::vector<std::function<void()>> OS::theme_funcs = {use_classic_theme, use_aero_theme,  use_metro_theme,     use_aqua_theme, use_greybird_theme,      use_ocean_theme,
                                                      use_blue_theme,    use_olive_theme, use_rose_gold_theme, use_dark_theme, use_brushed_metal_theme, use_high_contrast_theme};
...
bool OS::use_theme(std::string stheme)
{
